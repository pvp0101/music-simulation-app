...
--- steps to install:
1)Download the MusicSimulationApp1.mlappinstall file from this repository.
2)Open MATLAB (R2024b or latest recommended).
3)Double-click the .mlappinstall file or drag it into MATLAB to install.
4)Launch the app from the MATLAB Apps tab and start using it.
